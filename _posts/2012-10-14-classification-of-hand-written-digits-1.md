...
![Example email from my inbox, correctly classified as spam.](/assets/images/spam_email.png)
...
![Pair-wise scatter plots of the four attributes distinguishing three iris species.](/assets/images/iris_dataset.png)
...
![Left: Example image of a hand-written "6." Right: Numbering of pixels in the image.](/assets/images/digit_to_pixels.png)
...
![Training example of a hand-written "6," represented as a single row in a table.](/assets/images/digit_feature_vector.png)
